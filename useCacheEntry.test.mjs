...
describe("React hook `useCacheEntry`.", { concurrency: true }, () => {
  ...
  it("Without initial cache values for each cache key used.", () => {
  ...
  it("Initial cache values for each cache key used, replacing cache values.", () => {
    const cacheKeyA = "a";
  ...
  it("Initial cache value, mutating cache value.", () => {
    const cacheKey = "a";
